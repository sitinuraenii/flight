...
<li><a href="pnr.php"><i class="fa fa-desktop" aria-hidden="true"></i> Print Ticket</a></li>
		...
		mysqli_stmt_bind_result($stmt,$cnt,$id_user);
		mysqli_stmt_fetch($stmt);
		if($cnt==1)
		{
			echo "<h4 style='padding-left: 20px;'>id_user " . $id_user . "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; points</h4><br>";
